...
extern void F399_10262(EIF_REFERENCE);
extern EIF_TYPED_VALUE F399_10263(EIF_REFERENCE);
...
void F399_10262 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 398, Current, 2, 0, 13178);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(398, Current, 13178);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F399_10263)
EIF_TYPED_VALUE F399_10263 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 398, Current, 0, 0, 13179);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(398, Current, 13179);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
