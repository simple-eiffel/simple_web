...
extern EIF_TYPED_VALUE F410_10693(EIF_REFERENCE);
extern void F410_14554(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F410_10693 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 409, Current, 0, 0, 14998);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(409, Current, 14998);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F410_14554 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 409, Current, 0, 14553);
	RTSA(dtype);
	RTME(dtype, 0);
