...
extern EIF_TYPED_VALUE F1048_10056(EIF_REFERENCE);
extern void F1048_14541(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1047, Current, 0, 0, 11561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1047, Current, 11561);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1048_10056 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1047, Current, 0, 0, 11562);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1047, Current, 11562);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1048_14541 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1047, Current, 0, 14540);
	RTSA(dtype);
	RTME(dtype, 0);
