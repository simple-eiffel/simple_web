...
extern EIF_TYPED_VALUE F482_12923(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F482_12923 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 481, Current, 1, 1, 19772);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(481, Current, 19772);
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = RTCCL(tr1);
	loc1 = RTRV(RTWCT(11087, dtype, Dftype(Current)),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
