...
extern EIF_TYPED_VALUE F215_5835(EIF_REFERENCE);
...
RTOID (F215_5835)
EIF_TYPED_VALUE F215_5835 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 214, Current, 0, 0, 5837);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(214, Current, 5837);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
