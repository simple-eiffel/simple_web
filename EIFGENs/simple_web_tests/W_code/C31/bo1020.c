...
extern void F1020_14534(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1020_9646 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1019, Current, 0, 0, 10949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1019, Current, 10949);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F1020_14534 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1019, Current, 0, 14533);
	RTSA(dtype);
	RTME(dtype, 0);
