...
extern EIF_TYPED_VALUE F864_9577(EIF_REFERENCE);
...
EIF_TYPED_VALUE F864_9577 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 863, Current, 0, 0, 10853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(863, Current, 10853);
	RTIV(Current, RTAL);
	RTHOOK(1);
