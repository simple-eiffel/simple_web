...
extern EIF_TYPED_VALUE F912_9646(EIF_REFERENCE);
extern void F912_14534(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F912_9646 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 911, Current, 0, 0, 10943);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(911, Current, 10943);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F912_14534 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 911, Current, 0, 14533);
	RTSA(dtype);
	RTME(dtype, 0);
