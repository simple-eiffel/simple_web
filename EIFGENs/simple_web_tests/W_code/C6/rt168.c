...
extern void F168_5116(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F168_5117(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F168_5116 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 167, Current, 0, 1, 5138);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(167, Current, 5138);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,2);
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9204, "put_string_32", tr2))(tr2, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F168_5117 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 167, Current, 0, 1, 5139);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(167, Current, 5139);
	RTCC(arg1, 167, l_feature_name, 1, eif_new_type(467, 0x01), 0x01);
	RTIV(Current, RTAL);
