...
extern EIF_TYPED_VALUE F167_5115(EIF_REFERENCE);
...
EIF_TYPED_VALUE F167_5115 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 166, Current, 0, 0, 5137);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(166, Current, 5137);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80004E4, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1252,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
	...
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(9337, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
