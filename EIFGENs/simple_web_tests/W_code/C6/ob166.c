...
extern EIF_TYPED_VALUE F166_5114(EIF_REFERENCE);
...
EIF_TYPED_VALUE F166_5114 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 165, Current, 0, 0, 5136);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(165, Current, 5136);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80004E7, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1255,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
