...
extern EIF_TYPED_VALUE F185_5309(EIF_REFERENCE);
extern EIF_TYPED_VALUE F185_5310(EIF_REFERENCE);
extern EIF_TYPED_VALUE F185_5311(EIF_REFERENCE);
extern void F185_5312(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F185_5309 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 184, Current, 1, 0, 5319);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(184, Current, 5319);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F185_5310)
EIF_TYPED_VALUE F185_5310 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 184, Current, 0, 0, 5320);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(184, Current, 5320);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F185_5311)
EIF_TYPED_VALUE F185_5311 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 184, Current, 0, 0, 5321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(184, Current, 5321);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80000C0, 0,0); /* Result */
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {1105,441,0xFFFF};
		EIF_TYPE typres0;
	...
	*((EIF_NATURAL_8 *)tr4+3) = (EIF_NATURAL_8) (EIF_NATURAL_8) ((EIF_INTEGER_32) 1L);
	tr3 = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE))  RTWF(9631, Dtype(tr4)))(tr4).it_r;
	ur2 = tr3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5351, Dtype(tr1)))(tr1, ur1x, ur2x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
...
void F185_5312 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 184, Current, 0, 1, 5322);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(184, Current, 5322);
...
{
	GTCX
	RTOTS (5310,F185_5310)
	RTOTS (5311,F185_5311)
}
