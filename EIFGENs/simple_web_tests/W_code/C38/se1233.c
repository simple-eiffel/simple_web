...
extern EIF_TYPED_VALUE F1233_9577(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1233_9577 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1232, Current, 0, 0, 10854);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1232, Current, 10854);
	RTIV(Current, RTAL);
	RTHOOK(1);
