...
extern EIF_TYPED_VALUE F496_13170(EIF_REFERENCE);
...
EIF_TYPED_VALUE F496_13170 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 495, Current, 0, 0, 20003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(495, Current, 20003);
	RTIV(Current, RTAL);
	RTHOOK(1);
