...
extern EIF_TYPED_VALUE F391_9507(EIF_REFERENCE);
...
EIF_TYPED_VALUE F391_9507 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 390, Current, 2, 0, 10336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(390, Current, 10336);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		loc2 = RTCCL(tr1);
		loc2 = RTRV(eif_new_type(411, 0x01),loc2);
		tb1 = EIF_TEST(loc2);
		RTNHOOK(2,1);
