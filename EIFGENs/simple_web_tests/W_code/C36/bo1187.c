...
extern EIF_TYPED_VALUE F1187_9646(EIF_REFERENCE);
extern void F1187_14534(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F1187_9646 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1186, Current, 0, 0, 10959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1186, Current, 10959);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F1187_14534 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1186, Current, 0, 14533);
	RTSA(dtype);
	RTME(dtype, 0);
