...
extern EIF_TYPED_VALUE F158_5021(EIF_REFERENCE);
...
EIF_TYPED_VALUE F158_5021 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 157, Current, 0, 0, 5044);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(157, Current, 5044);
	RTIV(Current, RTAL);
	RTHOOK(1);
