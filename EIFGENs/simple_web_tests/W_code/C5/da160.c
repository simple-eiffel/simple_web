...
extern EIF_TYPED_VALUE F160_5031(EIF_REFERENCE);
extern EIF_TYPED_VALUE F160_5032(EIF_REFERENCE);
extern EIF_TYPED_VALUE F160_5033(EIF_REFERENCE);
...
EIF_TYPED_VALUE F160_5031 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F160_5032 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F160_5033 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 159, Current, 0, 0, 5055);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(159, Current, 5055);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(4919, "fractional_second", tr1));
