...
extern EIF_TYPED_VALUE F1076_9644(EIF_REFERENCE);
extern void F1076_14533(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F1076_9644 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1075, Current, 0, 0, 10925);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1075, Current, 10925);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F1076_14533 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1075, Current, 0, 14532);
	RTSA(dtype);
	RTME(dtype, 0);
