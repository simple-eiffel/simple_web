...
extern EIF_TYPED_VALUE F845_9646(EIF_REFERENCE);
extern void F845_14534(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F845_9646 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 844, Current, 0, 0, 10941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(844, Current, 10941);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F845_14534 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 844, Current, 0, 14533);
	RTSA(dtype);
	RTME(dtype, 0);
