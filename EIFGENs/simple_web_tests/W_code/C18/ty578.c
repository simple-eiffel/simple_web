...
extern EIF_TYPED_VALUE F578_9389(EIF_REFERENCE);
...
EIF_TYPED_VALUE F578_9389 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 577, Current, 0, 0, 9396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(577, Current, 9396);
	RTIV(Current, RTAL);
